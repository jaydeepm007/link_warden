...
async function getDashboardData(userId, query) {
    ...
    const numberOfPinnedLinks = await _lib_api_db__WEBPACK_IMPORTED_MODULE_0__/* .prisma */ ._.link.count({
        where: {
            AND: [
                {
                    collection: {
...
/* harmony export */ });
/* harmony import */ var _lib_api_controllers_dashboard_getDashboardDataV2__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8310);
...
async function dashboard(req, res) {
    ...
    if (req.method === "GET") {
        ...
        const data = await (0,_lib_api_controllers_dashboard_getDashboardDataV2__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(user.id, convertedData);
...
var __webpack_exports__ = __webpack_require__.X(0, [5746,8005,6211], () => (__webpack_exec__(5939)));
